...
- **Key Features:** Real-time computer vision, tracking with webcam
...
1. Clone the repo:
   ```bash
   git clone https://github.com/Tharuka926/ComputerVision_Project
2. Run Paint_Project/paint_main.py for drawing on live camera or run Scan_Project/scan_main.py for scanning function
